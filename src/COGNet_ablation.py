...
class COGNet_wo_copy(nn.Module):
...
class COGNet_wo_visit_score(nn.Module):
    """在CopyDrug_batch基础上将medication的encode部分修改为transformer encoder"""
    def __init__(self, voc_size, ehr_adj, ddi_adj, ddi_mask_H, emb_dim=64, device=torch.device('cpu:0')):
...
class COGNet_wo_graph(nn.Module):
    """在CopyDrug_batch基础上将medication的encode部分修改为transformer encoder"""
    def __init__(self, voc_size, ehr_adj, ddi_adj, ddi_mask_H, emb_dim=64, device=torch.device('cpu:0')):
...
class COGNet_wo_diag(nn.Module):
    """在CopyDrug_batch基础上将medication的encode部分修改为transformer encoder"""
    def __init__(self, voc_size, ehr_adj, ddi_adj, ddi_mask_H, emb_dim=64, device=torch.device('cpu:0')):
...
class COGNet_wo_proc(nn.Module):
    """在CopyDrug_batch基础上将medication的encode部分修改为transformer encoder"""
    def __init__(self, voc_size, ehr_adj, ddi_adj, ddi_mask_H, emb_dim=64, device=torch.device('cpu:0')):
...
class MedTransformerDecoder_wo_diag(nn.Module):
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, 
                 layer_norm_eps=1e-5) -> None:
...
class MedTransformerDecoder_wo_proc(nn.Module):
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, 
                 layer_norm_eps=1e-5) -> None:
...
class MedTransformerDecoder_wo_graph(nn.Module):
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, 
                 layer_norm_eps=1e-5) -> None:
